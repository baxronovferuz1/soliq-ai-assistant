...
#     """Bir nechta documentni bitta matnga aylantiradi"""
...
#         prompt_template = """Siz O'zbekiston Respublikasi soliq qonunlari bo'yicha professional yordamchi botsiz.
# Faqat quyidagi kontekstdan foydalanib, aniq va qisqa javob bering.
# Agar kontekstdan yetarli ma'lumot bo'lmasa, halol ravishda ayting.

# Kontekst: {context}

# Savol: {question}

# Javob (faqat o'zbek tilida, professional uslubda):"""

#         self.prompt = PromptTemplate.from_template(prompt_template)

#         # Zamonaviy LCEL chain
#         self.chain = (
#             {
